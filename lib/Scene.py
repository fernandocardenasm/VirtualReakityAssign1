...
class Scene:
    ...
    def __init__( self
        ...
        self.ground_geometry.Transform.value = avango.gua.make_trans_mat(0.0, -0.105, 0.0) * \
        ...
        self.box0_geometry.Transform.value = avango.gua.make_trans_mat(-0.15, -0.05, 0.0) * \
        ...
        self.box1_geometry.Transform.value = avango.gua.make_trans_mat(-0.15, 0.025, 0.0) * \
        ...
        self.box2_geometry.Transform.value = avango.gua.make_trans_mat(0.12, -0.075, 0.0) * \
                                             avango.gua.make_scale_mat(0.05)
        ...
        self.box3_geometry.Transform.value = avango.gua.make_trans_mat(0.13, -0.025, 0.0) * \
                                             avango.gua.make_scale_mat(0.05)
